...
-- Modules/Classic.lua – Classic Era (1.x) specific code
------------------------------------------------------------------------

local _, EDM = ...

------------------------------------------------------------------------
-- Classes: 9 classes in Classic (no Death Knight, Monk, Demon Hunter, Evoker)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- Pet resolution: Cache-only (no C_PlayerInfo in Classic)
------------------------------------------------------------------------
